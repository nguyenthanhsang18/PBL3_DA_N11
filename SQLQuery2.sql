...
(
	...
	DonViDaoTao nvarchar(100) null,
	ThoiGianBatDau DATE null,
	ThoiGianKetThuc DATE null,
	ChuyenNganh nvarchar(100)null,
	LoaiTotNghiep nvarchar(100) null,
)
alter table BANG_CAP alter column LoaiTotNghiep nvarchar(100)
ALTER TABLE BANG_CAP ADD CONSTRAINT fk_idhs FOREIGN KEY (IdHoSo) REFERENCES dbo.TAI_KHOAN (Id) ON DELETE CASCADE
CREATE TABLE NN_TH
(
	Id int identity primary key,
	LoaiNgonNgu nvarchar(100)  null,
	TrinhDo nvarchar(100)  null,
	BangCap NVARCHAR(1000)  NULL,
	Word BIT  NULL,
	Excel BIT  NULL,
	PowerPoint BIT  NULL,
	Outlook BIT  NULL,
...
alter table NN_TH alter column BangCap nvarchar(100) null
Alter Table NN_TH ADD IdHoSo int 
ALTER TABLE NN_TH ADD CONSTRAINT fk_idhs1 FOREIGN KEY (IdHoSo) REFERENCES dbo.TAI_KHOAN (Id) ON DELETE CASCADE
...
Alter Table KI_NANG ADD IdHoSo int 
ALTER TABLE KI_NANG add CONSTRAINT fk_idhs2 FOREIGN KEY (IdHoSo) REFERENCES dbo.TAI_KHOAN (Id) ON DELETE CASCADE
CREATE TABLE HO_SO
(
	Id INT PRIMARY KEY,
	...
	ViTriHienTai NVARCHAR(1000) NULL,
	ViTriMongMuon NVARCHAR(1000) NULL,
	MucLuongMongMuon nvarchar(100) NULL,
...
alter table HO_SO alter column NoiLamViec NVARCHAR(1000) NULL
alter table HO_SO Add Tinh nvarchar(100)
alter table HO_SO Add DiaChiChiTiet nvarchar(100) not null
alter table HO_SO alter column DiaChiChiTiet nvarchar(1000)
Alter table HO_SO alter column MucLuongMongMuon nvarchar(100);
alter table HO_SO alter column MucLuong nvarchar(100)
...
alter table CONG_VIEC ADD CONSTRAINT fk_iduser2 FOREIGN KEY (IdUser) REFERENCES TAI_KHOAN (Id)
select * from CONG_VIEC
Alter table CONG_VIEC Add Tinh nvarchar(100)
Alter table CONG_VIEC add DiaChiCHiTiet nvarchar(100)
...
alter table CONG_VIEC alter column DiaChiChiTiet nvarchar(1000)
...
ALTER TABLE dbo.CONG_VIEC_LUU ADD CONSTRAINT fk_iduser FOREIGN KEY (IdUser) REFERENCES dbo.TAI_KHOAN (Id) ON DELETE CASCADE
alter table dbo.CONG_VIEC_LUU add IdUser int 
...
CONG_VIEC.NgayHetHan, CONG_VIEC.TenCongTy,CONG_VIEC.SDT, CONG_VIEC.QuyMoNhanSu, CONG_VIEC.LinhVucHoatDong, CONG_VIEC.SoLuocCT, 
CONG_VIEC.TrangThai, CONG_VIEC.TrinhDo , CONG_VIEC.Tinh, CONG_VIEC.DiaChiCHiTiet
FROM dbo.CONG_VIEC, dbo.CONG_VIEC_LUU, dbo.TAI_KHOAN
WHERE dbo.CONG_VIEC.Id = dbo.CONG_VIEC_LUU.IdCongViec AND dbo.CONG_VIEC_LUU.IdUser = 7;
...
Select * From HO_SO, BANG_CAP where BANG_CAP.IdHoso = 1
Select * from BANG_CAP
Select * from KI_NANG
SELECT CONG_VIEC.Id, CONG_VIEC.IdUser, CONG_VIEC.TieuDe, CONG_VIEC.SoLuongTuyen, CONG_VIEC.GioiTinhTuyen, CONG_VIEC.MoTaCV, 
